...
public class Operator
{
    ...
    public static Func<TArg1, TArg2, TResult> CreateExpression<TArg1, TArg2, TResult>(Func<Expression, Expression, BinaryExpression> body, Boolean canCast)
    {
        ...
        try
        {
            ...
            {
                Expression castLeftParameter;
                Expression castRightParameter;
...
internal static class Operator<T>
{
    ...
    private static readonly Func<T, T, Boolean> _Equal;
    private static readonly Func<T, T, Boolean> _NotEqual;
    private static readonly Func<T, T, Boolean> _GreaterThan;
    private static readonly Func<T, T, Boolean> _GreaterThanOrEqual;
    private static readonly Func<T, T, Boolean> _LessThan;
    private static readonly Func<T, T, Boolean> _LessThanOrEqual;
...
internal static class Operator<TValue, TResult>
{
    ...
    private static readonly Func<TResult, TValue, TResult> _Add;
    private static readonly Func<TResult, TValue, TResult> _Subtract;
    private static readonly Func<TResult, TValue, TResult> _Multiply;
    private static readonly Func<TResult, TValue, TResult> _Divide;
