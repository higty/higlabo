...
namespace HigLabo.Net.Microsoft
{
    ...
    public partial class TableListRowsResponse : RestApiResponse<WorkbookTableRow>
    {
    }
    /// <summary>
    /// https://learn.microsoft.com/en-us/graph/api/table-list-rows?view=graph-rest-1.0
    ...
    public partial class MicrosoftClient
    {
        ...
        /// https://learn.microsoft.com/en-us/graph/api/table-list-rows?view=graph-rest-1.0
        /// </summary>
        public async IAsyncEnumerable<WorkbookTableRow> TableListRowsEnumerateAsync(TableListRowsParameter parameter, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            var res = await this.SendAsync<TableListRowsParameter, TableListRowsResponse>(parameter, cancellationToken);
            if (res.Value != null)
            {
