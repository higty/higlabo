...
public partial class MicrosoftClient
{
    ...
    /// https://learn.microsoft.com/en-us/graph/api/presence-clearpresence?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<PresenceClearpresenceResponse> PresenceClearpresenceAsync()
    {
    ...
    /// https://learn.microsoft.com/en-us/graph/api/presence-clearpresence?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<PresenceClearpresenceResponse> PresenceClearpresenceAsync(CancellationToken cancellationToken)
    {
        var p = new PresenceClearpresenceParameter();
    ...
    /// https://learn.microsoft.com/en-us/graph/api/presence-clearpresence?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<PresenceClearpresenceResponse> PresenceClearpresenceAsync(PresenceClearpresenceParameter parameter)
    {
    ...
    /// https://learn.microsoft.com/en-us/graph/api/presence-clearpresence?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<PresenceClearpresenceResponse> PresenceClearpresenceAsync(PresenceClearpresenceParameter parameter, CancellationToken cancellationToken)
    {
