...
public class SmtpMessage
{
    ...
    private List<SmtpContent> _Contents = new List<SmtpContent>();
    ...
    private SmtpContent _BodyTextContent = new SmtpContent();
    public SmtpMailHeaderCollection Headers { get; private set; } = new SmtpMailHeaderCollection();
