...
namespace HigLabo.OpenAI
{
    ...
    public partial class OrganizationUsageAudioTranscriptionsParameter : RestApiParameter, IRestApiParameter, IQueryParameterProperty
    {
        ...
        public OrganizationUsageAudioTranscriptionsQueryParameter QueryParameter { get; set; } = new OrganizationUsageAudioTranscriptionsQueryParameter();
    ...
    public class OrganizationUsageAudioTranscriptionsQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    {
        public async ValueTask<OrganizationUsageAudioTranscriptionsResponse> OrganizationUsageAudioTranscriptionsAsync(int start_Time)
        {
            return await this.SendJsonAsync<OrganizationUsageAudioTranscriptionsParameter, OrganizationUsageAudioTranscriptionsResponse>(OrganizationUsageAudioTranscriptionsParameter.Empty, System.Threading.CancellationToken.None);
        }
        public async ValueTask<OrganizationUsageAudioTranscriptionsResponse> OrganizationUsageAudioTranscriptionsAsync(int start_Time, CancellationToken cancellationToken)
        {
        ...
        {
            return await this.SendJsonAsync<OrganizationUsageAudioTranscriptionsParameter, OrganizationUsageAudioTranscriptionsResponse>(parameter, System.Threading.CancellationToken.None);
        }
