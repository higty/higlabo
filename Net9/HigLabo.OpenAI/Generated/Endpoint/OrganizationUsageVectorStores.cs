...
namespace HigLabo.OpenAI
{
    ...
    public partial class OrganizationUsageVectorStoresParameter : RestApiParameter, IRestApiParameter, IQueryParameterProperty
    {
        ...
        public OrganizationUsageVectorStoresQueryParameter QueryParameter { get; set; } = new OrganizationUsageVectorStoresQueryParameter();
    ...
    public class OrganizationUsageVectorStoresQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    {
        public async ValueTask<OrganizationUsageVectorStoresResponse> OrganizationUsageVectorStoresAsync(int start_Time)
        {
        ...
        public async ValueTask<OrganizationUsageVectorStoresResponse> OrganizationUsageVectorStoresAsync(int start_Time, CancellationToken cancellationToken)
        {
