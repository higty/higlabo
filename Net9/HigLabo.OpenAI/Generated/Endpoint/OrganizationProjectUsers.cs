...
namespace HigLabo.OpenAI
{
    ...
    public partial class OrganizationProjectUsersParameter : RestApiParameter, IRestApiParameter, IQueryParameterProperty
    {
        ...
        public OrganizationProjectUsersQueryParameter QueryParameter { get; set; } = new OrganizationProjectUsersQueryParameter();
    ...
    public class OrganizationProjectUsersQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    public partial class OpenAIClient
    {
        public async ValueTask<OrganizationProjectUsersResponse> OrganizationProjectUsersAsync(string project_Id)
        {
            ...
            return await this.SendJsonAsync<OrganizationProjectUsersParameter, OrganizationProjectUsersResponse>(p, System.Threading.CancellationToken.None);
        }
        ...
        {
            return await this.SendJsonAsync<OrganizationProjectUsersParameter, OrganizationProjectUsersResponse>(parameter, System.Threading.CancellationToken.None);
        }
