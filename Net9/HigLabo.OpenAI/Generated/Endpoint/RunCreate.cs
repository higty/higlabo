...
namespace HigLabo.OpenAI
{
    ...
    public partial class RunCreateParameter : RestApiParameter, IRestApiParameter, IAssistantApiParameter, IQueryParameterProperty
    {
        ...
        public RunCreateQueryParameter QueryParameter { get; set; } = new RunCreateQueryParameter();
        /// <summary>
    ...
    public class RunCreateQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    public partial class OpenAIClient
    {
        public async ValueTask<RunCreateResponse> RunCreateAsync(string thread_Id, string assistant_Id)
        {
            ...
            return await this.SendJsonAsync<RunCreateParameter, RunCreateResponse>(p, System.Threading.CancellationToken.None);
        }
