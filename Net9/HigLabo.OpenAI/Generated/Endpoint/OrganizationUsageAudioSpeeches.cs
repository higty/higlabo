...
namespace HigLabo.OpenAI
{
    ...
    public partial class OrganizationUsageAudioSpeechesParameter : RestApiParameter, IRestApiParameter, IQueryParameterProperty
    {
        ...
        public OrganizationUsageAudioSpeechesQueryParameter QueryParameter { get; set; } = new OrganizationUsageAudioSpeechesQueryParameter();
    ...
    public class OrganizationUsageAudioSpeechesQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    {
        public async ValueTask<OrganizationUsageAudioSpeechesResponse> OrganizationUsageAudioSpeechesAsync(int start_Time)
        {
        ...
        public async ValueTask<OrganizationUsageAudioSpeechesResponse> OrganizationUsageAudioSpeechesAsync(int start_Time, CancellationToken cancellationToken)
        {
