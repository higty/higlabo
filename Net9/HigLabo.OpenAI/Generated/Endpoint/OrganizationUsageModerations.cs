...
namespace HigLabo.OpenAI
{
    ...
    public partial class OrganizationUsageModerationsParameter : RestApiParameter, IRestApiParameter, IQueryParameterProperty
    {
        ...
        public OrganizationUsageModerationsQueryParameter QueryParameter { get; set; } = new OrganizationUsageModerationsQueryParameter();
    ...
    public class OrganizationUsageModerationsQueryParameter : IQueryParameter
    {
        /// <summary>
    ...
    {
        public async ValueTask<OrganizationUsageModerationsResponse> OrganizationUsageModerationsAsync(int start_Time)
        {
            return await this.SendJsonAsync<OrganizationUsageModerationsParameter, OrganizationUsageModerationsResponse>(OrganizationUsageModerationsParameter.Empty, System.Threading.CancellationToken.None);
        }
        public async ValueTask<OrganizationUsageModerationsResponse> OrganizationUsageModerationsAsync(int start_Time, CancellationToken cancellationToken)
        {
        ...
        {
            return await this.SendJsonAsync<OrganizationUsageModerationsParameter, OrganizationUsageModerationsResponse>(parameter, System.Threading.CancellationToken.None);
        }
