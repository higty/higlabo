...
namespace HigLabo.OpenAI
{
    ...
    /// </summary>
    public partial class AssistantModifyParameter : RestApiParameter, IRestApiParameter, IAssistantApiParameter
    {
    ...
    public partial class OpenAIClient
    {
        public async ValueTask<AssistantModifyResponse> AssistantModifyAsync(string assistant_Id)
        {
            ...
            return await this.SendJsonAsync<AssistantModifyParameter, AssistantModifyResponse>(p, System.Threading.CancellationToken.None);
        }
        ...
        {
            return await this.SendJsonAsync<AssistantModifyParameter, AssistantModifyResponse>(parameter, System.Threading.CancellationToken.None);
        }
