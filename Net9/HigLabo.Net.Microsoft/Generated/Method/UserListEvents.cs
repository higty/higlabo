...
public partial class UserListEventsResponse : RestApiResponse<Event>
{
}
/// <summary>
/// https://learn.microsoft.com/en-us/graph/api/user-list-events?view=graph-rest-1.0
...
public partial class MicrosoftClient
{
    ...
    /// https://learn.microsoft.com/en-us/graph/api/user-list-events?view=graph-rest-1.0
    /// </summary>
    public async IAsyncEnumerable<Event> UserListEventsEnumerateAsync(UserListEventsParameter parameter, [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        var res = await this.SendAsync<UserListEventsParameter, UserListEventsResponse>(parameter, cancellationToken);
        if (res.Value != null)
        {
