...
/// <summary>
/// https://learn.microsoft.com/en-us/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0
/// </summary>
...
public partial class MicrosoftClient
{
    ...
    /// https://learn.microsoft.com/en-us/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<ClaimsmappingPolicyUpdateResponse> ClaimsmappingPolicyUpdateAsync()
    {
    ...
    /// https://learn.microsoft.com/en-us/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<ClaimsmappingPolicyUpdateResponse> ClaimsmappingPolicyUpdateAsync(CancellationToken cancellationToken)
    {
        var p = new ClaimsmappingPolicyUpdateParameter();
    ...
    /// https://learn.microsoft.com/en-us/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<ClaimsmappingPolicyUpdateResponse> ClaimsmappingPolicyUpdateAsync(ClaimsmappingPolicyUpdateParameter parameter)
    {
    ...
    /// https://learn.microsoft.com/en-us/graph/api/claimsmappingpolicy-update?view=graph-rest-1.0
    /// </summary>
    public async ValueTask<ClaimsmappingPolicyUpdateResponse> ClaimsmappingPolicyUpdateAsync(ClaimsmappingPolicyUpdateParameter parameter, CancellationToken cancellationToken)
    {
