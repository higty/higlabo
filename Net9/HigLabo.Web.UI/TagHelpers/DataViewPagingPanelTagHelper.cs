...
[HtmlTargetElement("data-view-paging-panel")]
public class DataViewPagingPanelTagHelper : TagHelper
{
    ...
    {
        output.TagName = "div";
        output.AddClass("data-view-paging-panel", HtmlEncoder.Default);
        output.Attributes.Add("data-view-paging-panel", "true");
        {
        ...
        }
        {
            ...
            span.AddCssClass("page-number-panel");
            {
                ...
                tx.Attributes.Add("value", this.PageNumber.ToString());
