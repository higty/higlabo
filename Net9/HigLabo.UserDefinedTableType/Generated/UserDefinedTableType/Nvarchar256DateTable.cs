...
public partial class Nvarchar256DateTable : UserDefinedTableType<Nvarchar256DateTable.Record>
{
    public partial class Record : UserDefinedTableTypeRecord
    {
        private String _Value0 = "";
        private DateOnly _Value1;
        ...
        public override Object?[] GetValues()
        {
            ...
            oo[0] = this.Value0;
            oo[1] = this.Value1.ToDateTime(TimeOnly.MinValue);
            return oo;
        }
    }
    ...
    public override SqlDataRecord CreateSqlDataRecord()
    {
        ...
        metaData[1] = new SqlMetaData("Value1", SqlDbType.Date);
