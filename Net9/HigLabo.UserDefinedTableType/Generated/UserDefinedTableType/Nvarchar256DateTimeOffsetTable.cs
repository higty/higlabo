...
public partial class Nvarchar256DateTimeOffsetTable : UserDefinedTableType<Nvarchar256DateTimeOffsetTable.Record>
{
    public partial class Record : UserDefinedTableTypeRecord
    {
        private String _Value0 = "";
        private DateTimeOffset _Value1;
    ...
    public override SqlDataRecord CreateSqlDataRecord()
    {
        ...
        metaData[1] = new SqlMetaData("Value1", SqlDbType.DateTimeOffset, 0, 7);
