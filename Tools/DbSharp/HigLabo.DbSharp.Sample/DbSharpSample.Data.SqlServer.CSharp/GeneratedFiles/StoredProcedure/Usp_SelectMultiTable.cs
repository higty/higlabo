...
{
    public partial class Usp_SelectMultiTable : StoredProcedureWithResultSet<Usp_SelectMultiTable.AllDataTypeTableResultSet>
    {
        ...
        public new Usp_SelectMultiTable.AllDataTypeTableResultSet GetFirstResultSet()
        {
            return base.GetFirstResultSet() as Usp_SelectMultiTable.AllDataTypeTableResultSet;
        }
        public new Usp_SelectMultiTable.AllDataTypeTableResultSet GetFirstResultSet(Database database)
        {
            return base.GetFirstResultSet(database) as Usp_SelectMultiTable.AllDataTypeTableResultSet;
        }
        ...
        public ResultSetsList GetResultSetsList()
        {
            return this.GetResultSetsList(this.GetDatabase());
        }
        public ResultSetsList GetResultSetsList(Database database)
        {
            var rs = new ResultSetsList();
            var l = base.GetResultSetsList(database, CreateCreateResultSetMethod<AllDataTypeTableResultSet>(this.SetResultSet), CreateCreateResultSetMethod<IdentityTableResultSet>(this.SetResultSet), CreateCreateResultSetMethod<RowGuidColTableResultSet>(this.SetResultSet), CreateCreateResultSetMethod<MultiPkTableResultSet>(this.SetResultSet));
