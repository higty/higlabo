...
namespace HigLabo.DbSharpSample.SqlServer
{
    public partial class Usp_SelectMultiTable : StoredProcedureWithResultSetsList<Usp_SelectMultiTable.ResultSet, Usp_SelectMultiTable.ResultSetsList>
    {
        public partial class ResultSet : StoredProcedureResultSet
        {
            ...
            private String? _NotNullEnumColumn;
            ...
            public String? NotNullEnumColumn
            {
                get
                {
        ...
        protected override void SetResultSet(Usp_SelectMultiTable.ResultSet resultSet, IDataReader reader)
        {
            ...
            try
            {
                ...
                index += 1; if (reader[index] != DBNull.Value) r.EnumColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullBigIntColumn = reader.GetInt64(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullBinaryColumn = reader[index] as Byte[];
                index += 1; if (reader[index] != DBNull.Value) r.NotNullImageColumn = reader[index] as Byte[];
                index += 1; if (reader[index] != DBNull.Value) r.NotNullVarBinaryColumn = reader[index] as Byte[];
                index += 1; if (reader[index] != DBNull.Value) r.NotNullBitColumn = reader.GetBoolean(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullCharColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullNCharColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullNTextColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullNVarCharColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullTextColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullVarCharColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullXmlColumn = reader[index] as String;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullDateTimeColumn = reader.GetDateTime(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullSmallDateTimeColumn = reader.GetDateTime(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullDateColumn = DateOnly.FromDateTime((DateTime)reader[index]);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullTimeColumn = TimeOnly.FromTimeSpan((TimeSpan)reader[index]);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullDateTime2Column = reader.GetDateTime(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullDecimalColumn = reader.GetDecimal(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullMoneyColumn = reader.GetDecimal(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullSmallMoneyColumn = reader.GetDecimal(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullFloatColumn = reader.GetDouble(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullIntColumn = reader.GetInt32(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullRealColumn = reader.GetFloat(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullUniqueIdentifierColumn = reader.GetGuid(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullSmallIntColumn = reader.GetInt16(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullTinyIntColumn = reader.GetByte(index);
                index += 1; if (reader[index] != DBNull.Value) r.NotNullDateTimeOffsetColumn = (DateTimeOffset)reader[index];
                index += 1; if (reader[index] != DBNull.Value) r.NotNullSqlVariantColumn = reader[index] as Object;
                index += 1; if (reader[index] != DBNull.Value) r.NotNullEnumColumn = reader[index] as String;
            }
            catch (Exception ex)
            {
