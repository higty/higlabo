...
Nvarchar255Table
-------------------------------------*/
Create Type Nvarchar255Table As Table
...
RowIndexGuidTable
-------------------------------------*/
Create Type RowIndexGuidTable As Table
...
/*-------------------------------------
RowIndexGuidGuidTable
-------------------------------------*/
Create Type RowIndexGuidGuidTable As Table
(RowIndex Int Not Null
,CD1 Uniqueidentifier Not Null
,CD2 UniqueIdentifier Not Null
)
