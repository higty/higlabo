...
namespace HigLabo.OpenAI
{
    public class MessageObject
    {
        ...
        public List<MessageContentObject> Content { get; set; } = new List<MessageContentObject>();
    ...
    public class MessageTextObject
    {
        ...
        public List<MessageAnnotation> Annotations { get; set; } = new List<MessageAnnotation>();
