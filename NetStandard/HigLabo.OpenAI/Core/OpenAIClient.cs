...
namespace HigLabo.OpenAI
{
    ...
    public partial class OpenAIClient
    {
        ...
        public ServiceProvider ServiceProvider { get; private set; } = ServiceProvider.OpenAI;
        ...
        public OpenAISettings OpenAISettings { get; private set; } = new OpenAISettings();
        public AzureSettings AzureSettings { get; private set; } = new AzureSettings();
            ...
            where TResponse: RestApiResponse, new()
        {
            ...
            if (string.Equals(p.HttpMethod, "GET", StringComparison.OrdinalIgnoreCase) == false)
            {
                ...
                req.Content = new StringContent(requestBodyText, Encoding.UTF8, "application/json");
            }
