...
Copy "%path%StaticFiles\EditPanel.ts" "%targetPath%wwwroot\HigLabo\EditPanel.ts"
...
Copy "%path%StaticFiles\CKEditorTextbox.ts" "%targetPath%wwwroot\HigLabo\CKEditorTextbox.ts"
Copy "%path%StaticFiles\SelectTimePopupPanel.ts" "%targetPath%wwwroot\HigLabo\SelectTimePopupPanel.ts"
Copy "%path%StaticFiles\TinyMceTextBox.ts" "%targetPath%wwwroot\HigLabo\TinyMceTextBox.ts"
Copy "%path%StaticFiles\ViewPanel.ts" "%targetPath%wwwroot\HigLabo\ViewPanel.ts"
Copy "%path%StaticFiles\WebApiResult.ts" "%targetPath%wwwroot\HigLabo\WebApiResult.ts"
