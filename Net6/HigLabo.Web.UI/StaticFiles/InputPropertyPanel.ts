...
export class InputPropertyPanel {
    ...
    private getSearchRecordListPanel(inputPropertyPanel: Element) {
    ...
    private tabApiPathCallback(response: HttpResponse, tabPanel: Element) {
    ...
    private setCreatedRecord(inputPropertyPanel: Element, data) {
        const ipl = inputPropertyPanel;
        const elementType = $(ipl).getAttribute("element-type");
