...
{
    public partial class IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse : RestApiResponse
    {
        /// <summary>
        ...
        public Windows10EndpointProtectionConfiguration[] Value { get; set; }
    }
    public partial class MicrosoftClient
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10endpointprotectionconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse> IntuneDeviceconfigWindows10endpointprotectionconfigurationListAsync()
        {
            var p = new IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter, IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10endpointprotectionconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse> IntuneDeviceconfigWindows10endpointprotectionconfigurationListAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter, IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10endpointprotectionconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse> IntuneDeviceconfigWindows10endpointprotectionconfigurationListAsync(IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter parameter)
        {
            return await this.SendAsync<IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter, IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10endpointprotectionconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse> IntuneDeviceconfigWindows10endpointprotectionconfigurationListAsync(IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDeviceconfigWindows10endpointprotectionconfigurationListParameter, IntuneDeviceconfigWindows10endpointprotectionconfigurationListResponse>(parameter, cancellationToken);
        }
    }
}
