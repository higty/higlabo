...
{
    public partial class IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse : RestApiResponse
    {
        /// <summary>
        ...
        public IosGeneralDeviceConfiguration[] Value { get; set; }
    }
    public partial class MicrosoftClient
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationListAsync()
        {
            var p = new IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationListAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationListAsync(IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter parameter)
        {
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationListAsync(IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationListParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationListResponse>(parameter, cancellationToken);
        }
    }
}
