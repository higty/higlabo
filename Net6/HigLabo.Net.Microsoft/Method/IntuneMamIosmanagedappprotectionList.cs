...
{
    public partial class IntuneMamIosmanagedappprotectionListParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneMamIosmanagedappprotectionListResponse : RestApiResponse
    {
        /// <summary>
        ...
        public IosManagedAppProtection[] Value { get; set; }
    }
    public partial class MicrosoftClient
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-iosmanagedappprotection-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamIosmanagedappprotectionListResponse> IntuneMamIosmanagedappprotectionListAsync()
        {
            var p = new IntuneMamIosmanagedappprotectionListParameter();
            return await this.SendAsync<IntuneMamIosmanagedappprotectionListParameter, IntuneMamIosmanagedappprotectionListResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-iosmanagedappprotection-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamIosmanagedappprotectionListResponse> IntuneMamIosmanagedappprotectionListAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneMamIosmanagedappprotectionListParameter();
            return await this.SendAsync<IntuneMamIosmanagedappprotectionListParameter, IntuneMamIosmanagedappprotectionListResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-iosmanagedappprotection-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamIosmanagedappprotectionListResponse> IntuneMamIosmanagedappprotectionListAsync(IntuneMamIosmanagedappprotectionListParameter parameter)
        {
            return await this.SendAsync<IntuneMamIosmanagedappprotectionListParameter, IntuneMamIosmanagedappprotectionListResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-iosmanagedappprotection-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamIosmanagedappprotectionListResponse> IntuneMamIosmanagedappprotectionListAsync(IntuneMamIosmanagedappprotectionListParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneMamIosmanagedappprotectionListParameter, IntuneMamIosmanagedappprotectionListResponse>(parameter, cancellationToken);
        }
    }
}
