...
{
    public partial class IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse : RestApiResponse
    {
    ...
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationGetAsync()
        {
            var p = new IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter();
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationGetAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter();
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationGetAsync(IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter parameter)
        {
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-iosgeneraldeviceconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse> IntuneDeviceconfigIosgeneraldeviceconfigurationGetAsync(IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDeviceconfigIosgeneraldeviceconfigurationGetParameter, IntuneDeviceconfigIosgeneraldeviceconfigurationGetResponse>(parameter, cancellationToken);
        }
    }
}
