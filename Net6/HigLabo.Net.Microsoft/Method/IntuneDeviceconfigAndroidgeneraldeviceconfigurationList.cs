...
{
    public partial class IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse : RestApiResponse
    {
        /// <summary>
        ...
        public AndroidGeneralDeviceConfiguration[] Value { get; set; }
    }
    public partial class MicrosoftClient
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-androidgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse> IntuneDeviceconfigAndroidgeneraldeviceconfigurationListAsync()
        {
            var p = new IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter, IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-androidgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse> IntuneDeviceconfigAndroidgeneraldeviceconfigurationListAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter();
            return await this.SendAsync<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter, IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-androidgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse> IntuneDeviceconfigAndroidgeneraldeviceconfigurationListAsync(IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter parameter)
        {
            return await this.SendAsync<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter, IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-androidgeneraldeviceconfiguration-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse> IntuneDeviceconfigAndroidgeneraldeviceconfigurationListAsync(IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDeviceconfigAndroidgeneraldeviceconfigurationListParameter, IntuneDeviceconfigAndroidgeneraldeviceconfigurationListResponse>(parameter, cancellationToken);
        }
    }
}
