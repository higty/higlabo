...
{
    public partial class IntuneDeviceconfigWindows10generalconfigurationGetParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDeviceconfigWindows10generalconfigurationGetResponse : RestApiResponse
    {
    ...
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10generalconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10generalconfigurationGetResponse> IntuneDeviceconfigWindows10generalconfigurationGetAsync()
        {
            var p = new IntuneDeviceconfigWindows10generalconfigurationGetParameter();
            return await this.SendAsync<IntuneDeviceconfigWindows10generalconfigurationGetParameter, IntuneDeviceconfigWindows10generalconfigurationGetResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10generalconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10generalconfigurationGetResponse> IntuneDeviceconfigWindows10generalconfigurationGetAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDeviceconfigWindows10generalconfigurationGetParameter();
            return await this.SendAsync<IntuneDeviceconfigWindows10generalconfigurationGetParameter, IntuneDeviceconfigWindows10generalconfigurationGetResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10generalconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10generalconfigurationGetResponse> IntuneDeviceconfigWindows10generalconfigurationGetAsync(IntuneDeviceconfigWindows10generalconfigurationGetParameter parameter)
        {
            return await this.SendAsync<IntuneDeviceconfigWindows10generalconfigurationGetParameter, IntuneDeviceconfigWindows10generalconfigurationGetResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10generalconfiguration-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDeviceconfigWindows10generalconfigurationGetResponse> IntuneDeviceconfigWindows10generalconfigurationGetAsync(IntuneDeviceconfigWindows10generalconfigurationGetParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDeviceconfigWindows10generalconfigurationGetParameter, IntuneDeviceconfigWindows10generalconfigurationGetResponse>(parameter, cancellationToken);
        }
    }
}
