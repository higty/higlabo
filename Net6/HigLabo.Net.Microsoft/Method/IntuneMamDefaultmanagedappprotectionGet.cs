...
{
    public partial class IntuneMamDefaultmanagedappprotectionGetParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneMamDefaultmanagedappprotectionGetResponse : RestApiResponse
    {
    ...
    {
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-defaultmanagedappprotection-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamDefaultmanagedappprotectionGetResponse> IntuneMamDefaultmanagedappprotectionGetAsync()
        {
            var p = new IntuneMamDefaultmanagedappprotectionGetParameter();
            return await this.SendAsync<IntuneMamDefaultmanagedappprotectionGetParameter, IntuneMamDefaultmanagedappprotectionGetResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-defaultmanagedappprotection-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamDefaultmanagedappprotectionGetResponse> IntuneMamDefaultmanagedappprotectionGetAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneMamDefaultmanagedappprotectionGetParameter();
            return await this.SendAsync<IntuneMamDefaultmanagedappprotectionGetParameter, IntuneMamDefaultmanagedappprotectionGetResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-defaultmanagedappprotection-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamDefaultmanagedappprotectionGetResponse> IntuneMamDefaultmanagedappprotectionGetAsync(IntuneMamDefaultmanagedappprotectionGetParameter parameter)
        {
            return await this.SendAsync<IntuneMamDefaultmanagedappprotectionGetParameter, IntuneMamDefaultmanagedappprotectionGetResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-mam-defaultmanagedappprotection-get?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneMamDefaultmanagedappprotectionGetResponse> IntuneMamDefaultmanagedappprotectionGetAsync(IntuneMamDefaultmanagedappprotectionGetParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneMamDefaultmanagedappprotectionGetParameter, IntuneMamDefaultmanagedappprotectionGetResponse>(parameter, cancellationToken);
        }
    }
}
