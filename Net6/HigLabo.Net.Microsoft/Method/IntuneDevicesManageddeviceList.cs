...
{
    public partial class IntuneDevicesManageddeviceListParameter : IRestApiParameter, IQueryParameterProperty
    {
        public enum Field
        {
        }
    ...
    public partial class IntuneDevicesManageddeviceListResponse : RestApiResponse
    {
        /// <summary>
        ...
        public ManagedDevice[] Value { get; set; }
    }
    public partial class MicrosoftClient
    {
        ...
        /// </summary>
        public async Task<IntuneDevicesManageddeviceListResponse> IntuneDevicesManageddeviceListAsync()
        {
            var p = new IntuneDevicesManageddeviceListParameter();
            return await this.SendAsync<IntuneDevicesManageddeviceListParameter, IntuneDevicesManageddeviceListResponse>(p, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-devices-manageddevice-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDevicesManageddeviceListResponse> IntuneDevicesManageddeviceListAsync(CancellationToken cancellationToken)
        {
            var p = new IntuneDevicesManageddeviceListParameter();
            return await this.SendAsync<IntuneDevicesManageddeviceListParameter, IntuneDevicesManageddeviceListResponse>(p, cancellationToken);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-devices-manageddevice-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDevicesManageddeviceListResponse> IntuneDevicesManageddeviceListAsync(IntuneDevicesManageddeviceListParameter parameter)
        {
            return await this.SendAsync<IntuneDevicesManageddeviceListParameter, IntuneDevicesManageddeviceListResponse>(parameter, CancellationToken.None);
        }
        /// <summary>
        /// https://docs.microsoft.com/en-us/graph/api/intune-devices-manageddevice-list?view=graph-rest-1.0
        /// </summary>
        public async Task<IntuneDevicesManageddeviceListResponse> IntuneDevicesManageddeviceListAsync(IntuneDevicesManageddeviceListParameter parameter, CancellationToken cancellationToken)
        {
            return await this.SendAsync<IntuneDevicesManageddeviceListParameter, IntuneDevicesManageddeviceListResponse>(parameter, cancellationToken);
        }
    }
}
